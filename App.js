...
const desktopLogin = StyleSheet.create({
  ...
  motherFigure: { width: 128, height: 208, alignItems: "center", justifyContent: "flex-end", zIndex: 3 },
  motherHair: {
    position: "absolute",
    top: 7,
    width: 86,
  ...
  sectionHeader: { flexDirection: "row", alignItems: "center", gap: 14, marginTop: 42, marginBottom: 28 },
  headerIcon: {
    width: 38,
    height: 38,
    borderRadius: 19,
  ...
  roleTitle: { fontSize: 30, fontWeight: "900", marginBottom: 18 },
  roleBody: { color: "#CBD5E1", fontSize: 21, lineHeight: 30 },
  roleArt: {
    position: "absolute",
    right: 190,
    height: "100%",
