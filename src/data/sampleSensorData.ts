...
const greenScenario = {
  ...
  vitals: {
    ...
    oxygen: { title: "Oxygen SpO2", value: "99", unit: "%", status: "normal" },
...
const yellowScenario: SensorData = {
  ...
  vitals: {
    ...
    oxygen: { title: "Oxygen SpO2", value: "96", unit: "%", status: "normal" },
...
const redScenario: SensorData = {
  ...
  vitals: {
    ...
    oxygen: { title: "Oxygen SpO2", value: "92", unit: "%", status: "danger" },
